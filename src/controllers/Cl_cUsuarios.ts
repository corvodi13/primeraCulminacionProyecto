    ...
    constructor(equiposIniciales: Cl_mEquipos[], servicio: Cl_sEquipo) {
        ...
        this.vista.onReportarFalla(async () => {
            ...
            if (equipo) {
                ...
                const txtObservacion = (document.getElementById("inp-descripcion-reporte") as HTMLTextAreaElement).value;
                ...
                if (exito) {
                    ...
                    (document.getElementById("inp-descripcion-reporte") as HTMLTextAreaElement).value = "";
